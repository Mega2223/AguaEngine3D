...
void main(){
    ...
    gl_Position.y += (
        cos(actualPos.z/3 + iteration * 0.0025F - c1) * .1F + //if you're wondering these came to me in a dream
        cos(actualPos.x/3 - iteration * 0.0025F + c1) * .1F +
        cos(actualPos.z/1 - iteration * 0.043F * sin(c1*3.14)) * .14F +
        cos(actualPos.x/1 - iteration * 0.0043F * cos(c1*3.14)) * .14F +
        cos(actualPos.z/.5F + iteration * 0.05F) * .13F +
        cos(actualPos.x/.5F + iteration * 0.05F) * .13F
    );
